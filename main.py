...
with app.app_context():
    ...
    class Hr(UserMixin, db.Model):
        id = db.Column(db.Integer, primary_key=True)
        day_1 = db.Column(db.Boolean)
        day_2 = db.Column(db.Boolean)
        day_3 = db.Column(db.Boolean)
        day_4 = db.Column(db.Boolean)
        day_5 = db.Column(db.Boolean)
        day_6 = db.Column(db.Boolean)
        day_7 = db.Column(db.Boolean)
        day_8 = db.Column(db.Boolean)
        day_9 = db.Column(db.Boolean)
        day_10 = db.Column(db.Boolean)
        day_11 = db.Column(db.Boolean)
        day_12 = db.Column(db.Boolean)
        day_13 = db.Column(db.Boolean)
        day_14 = db.Column(db.Boolean)
        day_15 = db.Column(db.Boolean)
        day_16 = db.Column(db.Boolean)
        day_17 = db.Column(db.Boolean)
        day_18 = db.Column(db.Boolean)
        day_19 = db.Column(db.Boolean)
        day_20 = db.Column(db.Boolean)
        day_21 = db.Column(db.Boolean)
        day_22 = db.Column(db.Boolean)
        day_23 = db.Column(db.Boolean)
        day_24 = db.Column(db.Boolean)
        day_25 = db.Column(db.Boolean)
        day_26 = db.Column(db.Boolean)
        day_27 = db.Column(db.Boolean)
        day_28 = db.Column(db.Boolean)
        day_29 = db.Column(db.Boolean)
        day_30 = db.Column(db.Boolean)
        day_31 = db.Column(db.Boolean)
        phone = db.Column(db.String(100))


    class DataEntryLog(db.Model):
        id = db.Column(db.Integer, primary_key=True)
...
admin.add_view(MyModelView(Hr, db.session))
admin.add_view(MyModelView(DataEntryLog, db.session))
...
def logged():
    ...
    if current_user.role=="hr":
        ...
        return render_template('hr.html', labels=x, data=y)
...
@app.route('/update-check-marks', methods=['POST'])
    ...
    if 'user_id' in session:
        ...
        if user.role == 'data entry':
            for day in range(1, 32):
                checked = request.form.get('day_{}'.format(day))
                data_entry_log = DataEntryLog.query.filter_by(user_id=user_id, day=day).first()

                if data_entry_log:
                    data_entry_log.checked = checked == 'True'
                else:
                    data_entry_log = DataEntryLog(user_id=user_id, day=day, checked=checked == 'True')
                    db.session.add(data_entry_log)
